...
> {
  ...
  branchs = {
     ...
     * @request GET:/Branchs
     */
    branchsList: (query?: { id?: number | null }, params: RequestParams = {}) =>
  ...
  employee = {
     ...
     */
    employeeDelete: (query?: { id?: number }, params: RequestParams = {}) =>
      this.request<number, any>({
        path: `/Employee`,
        method: 'DELETE',
        query: query,
  ...
  lookUp = {
     ...
     * @request GET:/LookUp
     */
    lookUpList: (params: RequestParams = {}) =>
      this.request<LookUpData[], any>({
        path: `/LookUp`,
        method: 'GET',
        format: 'json',
  ...
  lookupType = {
     ...
     */
    lookupTypeList: (params: RequestParams = {}) =>
  ...
  product = {
     ...
     * @request GET:/Product
     */
    productList: (query?: { id?: number | null }, params: RequestParams = {}) =>
  ...
  role = {
     ...
     * @request GET:/Role
     */
    roleList: (query?: { id?: number | null }, params: RequestParams = {}) =>
     ...
     * @request POST:/Role
     */
    roleCreate: (data: Role, params: RequestParams = {}) =>
      this.request<number, any>({
        path: `/Role`,
        method: 'POST',
        body: data,
     ...
     * @request PUT:/Role
     */
    roleUpdate: (data: Role, params: RequestParams = {}) =>
      this.request<number, any>({
        path: `/Role`,
        method: 'PUT',
        body: data,
